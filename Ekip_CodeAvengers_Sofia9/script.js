...
const unescoSites = [
    ...
    { 
        ...
        mainText: "Стенописите от 1259 г. се отличават с реализъм и хуманизъм, рядко срещани за времето си. Те са сред най-ценните паметници на европейското средновековно изкуство."
    },
    { 
        id: 10, 
